...
void mapSUST(){
    loop(i,0,84) ///shahporan hall
     ...
     {
         if(i==60 || i==64)cout<<'*';
         else if(i>=92 && i<=96)cout<<'E';
         else if(i>=75 && i<=78)cout<<'T';
         else cout<<' ';
     }eline;
      loop(i,0,100) /// e build
     {
     ...
     {
         if(i>=30 && i<=34)cout<<'D';
         else if(i==60 || i==64)cout<<'*';
         else if(i>=88 && i<=92)cout<<'A';
         else cout<<' ';
     }eline;
         loop(i,0,100) ///d building and a building
         {
         ...
         loop(i,0,100) ///d building and a building
         {
             ...
             {
                 if(i==60)cout<<'*';
                 else if(i>=64 && i<96)cout<<'*';
                 else cout<<' ';
             }eline;
             loop(i,0,90)
             {
                 if(i==60)cout<<'*';else cout<<' ';
             }eline;
         loop(i,0,96) /// a building road
             ...
             {
                 if(i>=10 && i<=14)cout<<'H';
                 else if(i==50 || i==74)cout<<'*';
                 else cout<<' ';
             }eline;
             loop(i,0,90) /// ladies hall and chottor
             {
                 if(i==10 || i==14)cout<<'H';
                 else if(i>=14 && i<=50 || i==74)cout<<'*';
                 else cout<<' ';
             }eline;
             loop(i,0,90) /// ladies hall and chottor
             {
